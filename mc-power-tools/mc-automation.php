...
for ($k = 0 ; $k < $total_items; $k++){
	...
	echo ('&lt;form action="' . ($installurl) . '/mc-end-point/lead-magnet.php" method="get"&gt;&lt;input id="mce-FNAME" class="required" name="FNAME" required="" type="text" value="" placeholder="Enter your name here..." /&gt;');
		echo nl2br ("\n");
		echo nl2br ("\n");
	echo ('&lt;input id="mce-EMAIL" class="required email" name="EMAIL" required="" type="email" value="" placeholder="Enter your email here..." /&gt;&lt;input name="WORKFLOW_ID" type="hidden" value="' . ($result['automations'][$x]['id']) . '" /&gt;&lt;input name="WORKFLOW_EMAIL_ID" type="hidden" value="' . ($email_id['emails'][0]['id']) . '" /&gt;');
		echo nl2br ("\n");
		echo nl2br ("\n");
